...
const spawn = __webpack_require__(4).spawn;
...
// CONCATENATED MODULE: ./src/collect_command.js


/* harmony default export */ var collect_command = (function (_x) {
  return _ref.apply(this, arguments);
});

function _ref() {
  _ref = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee(dir) {
...
commander_default.a.version(version).name('Swatcher - track UI changes like a git history').description('This project aimed to collect screenshots from UI tests and store them to S3 compatible storage.\n' + 'Screenshots are referenced by their name and every new one will be compared with old ones.\n' + 'It will be displayed in HTML report if there any differences. This is not screenshot or snapshot\n' + 'testing, this is history of the each screen\'s snapshot.');
commander_default.a.command('collect <dir>').description('Collect screenshots from specified directory').action(collect_command);
commander_default.a.parse();
